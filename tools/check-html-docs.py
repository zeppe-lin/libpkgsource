...
def main() -> int:
    ...
    required = [
        ...
        "abi.html",
        "testing.html",
        "manual/libpkgsource.3.html",
        "manual/pkgsource_model.3.html",
        "manual/pkgsource_profile.3.html",
        "manual/pkgsource_recipe.3.html",
        "manual/pkgsource_snapshot.3.html",
        "manual/pkgsource_codec.3.html",
        "protocols/source-records-v1.html",
        "history/3.0-authority-reset.html",
        "api/index.html",
        "assets/house.css",
